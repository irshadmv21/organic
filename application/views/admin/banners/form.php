        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                <div class="col-md-12" data-select2-id="15">
                        <div class="card">
                            <form class="form-horizontal" id="banner-form" action="javascript:;" data-action=<?=@$action?>>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                        <label for="fname" class="col-sm-3 text-right control-label col-form-label">Banner Name</label>
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="name" placeholder="Banner Name" value="<?=@$banner['name']?>" name="name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="custom-file">
                                                ...
                                                <img id="img-thumb_130" src="<?=$base_path.@$banner['thumb'];?>" <?php if(!@$banner['thumb']){?> style="display: none;" <?php } ?>>
