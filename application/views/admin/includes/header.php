...
<head>
    ...
    <title>Organic Roots | <?=@$page_title?></title>
    <!-- Custom CSS -->
    <link href="<?=base_url()?>assets/assets/libs/flot/css/float-chart.css" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?=base_url()?>assets/assets/libs/jquery-steps/jquery.steps.css" rel="stylesheet">
    <link href="<?=base_url()?>assets/assets/libs/jquery-steps/steps.css" rel="stylesheet">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('banners');?>" aria-expanded="false"><i class="fas fa-image"></i><span class="hide-menu">Banners</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('categories');?>" aria-expanded="false"><i class="fas fa-list-alt"></i><span class="hide-menu">Categories</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('farmers');?>" aria-expanded="false"><i class="mdi mdi-leaf"></i><span class="hide-menu">Farmers</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('customers');?>" aria-expanded="false"><i class="fas fa-users"></i><span class="hide-menu">Customers</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('postcodes');?>" aria-expanded="false"><i class="fas fa-envelope"></i><span class="hide-menu">Postcodes</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="<?=base_url('products');?>" aria-expanded="false"><i class="fas fa-clipboard-list"></i><span class="hide-menu">Products</span></a></li>
